		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "radhe krishna",
									"targetURL": "#radhekrishna-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"radhekrishna-display": {
								"semanticObject": "radhekrishna",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5.rk.onlyui",
									"url": sap.ui.require.toUrl("sapui5/rk/onlyui")
								}
							}
						}
					}
